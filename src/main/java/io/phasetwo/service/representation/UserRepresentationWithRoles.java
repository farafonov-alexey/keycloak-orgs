...
public class UserRepresentationWithRoles {
  ...
  private @Valid List<OrganizationRole> organizationRoles =
      Lists.newArrayList();
  ...
  public void setId(UserRepresentation user) { this.user = user; }

  public UserRepresentationWithRoles
  organizationRoles(List<OrganizationRole> orgRoles) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UserRepresentationWithRoles userRepresentationWithRole =
        (UserRepresentationWithRoles)o;
    return Objects.equals(user, userRepresentationWithRole.user) &&
        Objects.equals(organizationRoles,
                       userRepresentationWithRole.organizationRoles);
  }
  ...
  public String toString() {
    ...
    sb.append("    orgRoles: ")
        .append(toIndentedString(organizationRoles))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }
